...
const NoteCard = ({note,setNotes}) => {
    const handelDelete = async(e,id)=>{
       e.preventDefault();
       if(!window.confirm("Do you wanna delete this note")) return;
       try {
  ...
  return (
    ...
    className='card bg-[#E8DCC8] bg-base-100 hover:shadow-lg transition-all duration-200 border-t-4 border-solid border-[#FFD7E9]'>
